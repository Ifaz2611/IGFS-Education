...
import { db } from '../src/firebase'; // path to your firebase.ts
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {['firstName', 'lastName'].map((field) => (
                  <div key={field}>
                    ...
                    <input
                      ...
                      id={field}
                      name={field}
                      value={formData[field as keyof ContactFormData] as string}
              ...
              <motion.div variants={fadeInUp} className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={name}>
                    ...
                    {errors[name as keyof ContactFormData] && <p className="mt-1 text-sm text-red-500">{errors[name as keyof ContactFormData]}</p>}
                  </div>
                ))}
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="grid sm:grid-cols-2 gap-6">
                {[
                  { label: 'Preferred Mode of Counselling*', name: 'counsellingMode', options: ['In-Person', 'Virtual'] },
                  { label: 'How will you fund your education?*', name: 'funding', options: ['Self-funded', 'Education Loan', 'Scholarship'] }
                ].map(({ label, name, options }) => (
                  <div key={name}>
