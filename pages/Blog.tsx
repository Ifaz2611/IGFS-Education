...
const Blog: React.FC = () => {
    ...
    // Debug: Check if blogPosts exist
    if (!blogPosts || blogPosts.length === 0) {
        return (
            <div className="bg-brand-light dark:bg-gray-900 min-h-screen">
                <div className="container mx-auto p-10">
                    <h1 className="text-2xl text-red-500">No blog posts found!</h1>
                    <p>Check your constants file.</p>
                </div>
            </div>
        );
    }
                            ...
                            <motion.div
                                ...
                                <div className="overflow-hidden">
                                    <motion.img
                                        ...
                                        onError={(e) => {
                                            console.log('Image failed to load:', post.img);
