...
const ServiceCard = ({ title, description, benefits, caseStudy, image, reverse = false }: { title: string, description: string, benefits: string[], caseStudy: { name: string, story: string }, image: string, reverse?: boolean }) => {
    ...
    const services = [
        {
            ...
            benefits: ["Access to a database of thousands of universities.", "Personalized shortlisting to save you time and effort.", "Expert advice on emerging fields and career prospects."],
            caseStudy: { name: "Ananya, B.Tech in AI", story: "IGFS helped me discover a specialized AI program in the USA that perfectly matched my passion for robotics. I hadn't even heard of the university before their recommendation!" },
        ...
        },
        {
            ...
            benefits: ["Error-free application submission.", "Guidance on writing impactful essays and SOPs.", "Review by experts to enhance your application's quality."],
            caseStudy: { name: "Carlos, MBA Applicant", story: "My application essays were good, but the IGFS review team helped me make them great. Their feedback on my SOP was a game-changer, and I got into my dream business school." },
        ...
        },
        {
            ...
            benefits: ["Identification of relevant scholarship opportunities.", "Assistance with scholarship application essays.", "Advice on financial planning and documentation."],
            caseStudy: { name: "Fatima, M.Sc. in Environmental Science", story: "I was worried about the high tuition fees in Italy. IGFS found a university-specific scholarship that covered 50% of my costs, making my dream affordable." },
        ...
        },
        {
            ...
            benefits: ["Step-by-step guidance on the visa application.", "Thorough documentation checks to avoid rejections.", "Mock interview preparation to build your confidence."],
            caseStudy: { name: "Liam, Ph.D. in History", story: "The visa interview was my biggest fear. The mock sessions with IGFS were incredibly helpful. I went in confident and prepared, and the process was smooth." },
            ...
            <header className="relative flex items-center justify-center h-screen text-center text-white overflow-hidden">
                ...
                <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.h1
                        ...
                        className="text-4xl md:text-5xl font-extrabold">Our Comprehensive Services</motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.2 }}
                        className="mt-4 text-lg text-gray-200 max-w-3xl mx-auto">From your first thought of studying abroad to your first day on campus, we're with you at every step.</motion.p>
                </div>
            </header>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-gray-300">Our services are designed to give you the competitive edge. Let's work together to achieve your academic goals.</p>
                     <motion.div
                        ...
                        whileTap={{ scale: 0.95 }}>
                        <Link to="/contact" className="mt-8 inline-block bg-brand-secondary text-brand-primary font-semibold py-3 px-10 rounded-lg shadow-md hover:opacity-90 transition-colors">
